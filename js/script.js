document.addEventListener("DOMContentLoaded", function () {
  if (-1 !== window.location.href.indexOf("#medios")) {
  ...
  window.matchMedia("(max-width: 575.98px)").matches
    ? (document
      ...
      document
        .getElementById("compartir")
        .setAttribute("data-bs-target", "#collapseCompartir"),
      document
        .getElementById("descargarmedia")
        .setAttribute("data-bs-toggle", "collapse"),
      document
        .getElementById("descargarmedia")
        .setAttribute("data-bs-target", "#collapseDescargar"),
      document
        .getElementById("collapseCompartir")
        .setAttribute("class", "collapse"),
      document
        .getElementById("collapseDescargar")
        .setAttribute("class", "collapse"),
      document
        .getElementById("compartir")
